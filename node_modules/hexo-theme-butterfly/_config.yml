...
index_img: /image/index.jpg

# If the banner of page not setting, it will show the top_img
default_top_img: /image/index.jpg
...
aside:
  ...
  card_author:
    ...
    button:
      ...
      icon: fab fa-github
      text: Follow Me
      link: https://github.com/holoSamaa
  card_announcement:
    enable: true
...
jsdelivr_cdn:
  ...
  cdn_url_prefix: https://cdn.jsdelivr.net/gh/holosamaa/imagerepo/
  
  # git_repo_url是你github上的静态资源仓库的url，应该形如git@github.com:<username>/<repo>.git
  git_repo_url: git@github.com:holoSamaa/ImageRepo.git
